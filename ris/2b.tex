...
\begin{scope}[yshift=-1cm]
    \draw[->] (1,1) -- (1,5.5);
    \draw[line width=3pt, orange] (1,1.5) ++(0.5,0) node[right,black] {21} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,2) ++(0.5,0) node[right,black] {26} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,2.5) ++(0.5,0) node[right,black] {31} -- ++ (-1,0) ;

    \draw[line width=3pt, orange] (1,4) ++(0.5,0) node[right,black] {44} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,4.5) ++(0.5,0) node[right,black] {49} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,5) ++(0.5,0) node[right,black] {54} -- ++ (-1,0) ;
\end{scope}

\begin{scope}[yshift=0.5cm,xshift=1cm]
    \lineann[2]{90}{3}{$\Delta R_m=23$}
\end{scope}
\begin{scope}[yshift=3.5cm,xshift=1cm]
    \lineannt[3]{90}{0.5}{$\Delta R_\lambda=5$}
\end{scope}
