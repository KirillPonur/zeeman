...
\begin{scope}[yshift=-1cm]
    \draw[->] (1,1) -- (1,5.5);
    \draw[line width=3pt, orange] (1,1.5) ++(0.5,0) node[right,black] {1.50} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,2) ++(0.5,0) node[right,black] {1.58} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,2.5) ++(0.5,0) node[right,black] {1.65} -- ++ (-1,0) ;

    \draw[line width=3pt, orange] (1,4) ++(0.5,0) node[right,black] {1.81} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,4.5) ++(0.5,0) node[right,black] {1.86} -- ++ (-1,0) ;
    \draw[line width=3pt, orange] (1,5) ++(0.5,0) node[right,black] {1.92} -- ++ (-1,0) ;
\end{scope}

\begin{scope}[yshift=1cm,xshift=1cm]
    \lineann[2]{90}{2.5}{$\Delta R_m=0.286$}
\end{scope}
\begin{scope}[yshift=3.5cm,xshift=1cm]
    \lineannt[3]{90}{0.5}{$\Delta R_\lambda=0.06$}
\end{scope}
